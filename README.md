...
Project Description:
This project is a menu-driven console-based program that imitates an ATM system. 
It allows a user to interact through the console using numeric input options.
